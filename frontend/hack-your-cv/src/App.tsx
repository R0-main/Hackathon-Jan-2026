...
import './App.css';
import { useI18n, LanguageSwitcher, type TFunction } from './i18n';
...
// Header Component
const Header = ({ onStartCV, t }: { onStartCV: () => void; t: TFunction }) => {
...
// Hero CTA Component
const HeroCTA = ({ onStartCV, t }: { onStartCV: () => void; t: TFunction }) => {
  return (
...
const BeforeAfterVisual = ({ t }: { t: TFunction }) => {
  return (
...
const WhoIsThisFor = ({ t }: { t: TFunction }) => (
        ...
        <section id="faq" className="faq-section">
          <div className="faq-container">
            ...
            <div className="faq-list">
              <FAQItem
                question={t('whatIsAts')}
                answer={t('atsAnswer')}
              />
              <FAQItem
                question={t('doesItReplace')}
                answer={t('replaceAnswer')}
              />
              <FAQItem
                question={t('isItFree')}
                answer={t('freeAnswer')}
